...
class allVisa extends React.Component {
  constructor() {
    super();
    this.state = {
        Email: '',
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Visa List</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                {ctx.value.VisaOFList.map((item,i) => (
                                  <tr key={i}>
                                    <td >{i}</td>
                                    <td>{item.name}</td>
                                    <td > {item.country} </td>
                                    ...
                                    onClick={()=>{
                                      ctx.actions.DeleteVisa(item)
                                    }}
                                    /></td> 

                                   <td> 
                                     <Link to={`/EditVisa?visa=${item._id}`}>
                                     <Icon icon="edit" style={{cursor: 'pointer'}} color="info" marginLeft={10} size={30} />
                                     </Link>
                                     </td>      
