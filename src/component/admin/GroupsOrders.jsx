...
class GroupsOrders extends React.Component {
  constructor() {
    super();
    this.state = {
      Email: '',
                      ...
                      <div className="container-fluid">
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Groups Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                {ctx.value.GroupsOrders.map((item, i) => (
                                  <tr key={i}>
                                    <td >{i + 1}</td>
                                    <td >{item.uptime}</td>
                                    <td>{item.user}</td>
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Guests Groups Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              <thead className="thead-dark">
