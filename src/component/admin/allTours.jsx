                  ...
                  <div className="container-fluid">
                    ...
                    <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Tours List</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                {ctx.value.ListOFTour.map((item,i) => (
                                  <tr key={i}>
                                    <td >{i}</td>
                                    <td>{item.name}</td>
                                    <td > {item.Country} </td>
                                    ...
                                    onClick={()=>{
                                      ctx.actions.DeleteTours(item)
                                    }}
                                    /></td>
                                   <td> 
                                     <Link to={`/EditTours?Tours=${item._id}`}>
