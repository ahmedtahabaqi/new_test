                      ...
                      <div className="container-fluid">
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Visa Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                {ctx.value.VisaOrders.map((item, i) => (
                                  <tr key={i}>
                                    <td>{i + 1}</td>
                                    <td >{item.uptime}</td>
                                    <td>{item.user}</td>
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Guests Visa Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              <thead className="thead-dark">
                       ...
                       <img id="Departure" src={Arrival} alt='img'/>
                                              ...
                                              <Card id="CardTiket" body>
                                                ...
                                                <Row style={{ marginRight: 0 + "px" }}>
                                                  ...
                                                  <Col>
                                                    <img id="AirilineLogo" src={item.Data[0].ReturnairlineLogo[0]} alt='img'/>
                                                    <p id="AirilineName">
                                              ...
                                              <div style={item.Data[0].ReturnStops === 1 || item.Data[0].ReturnStops === 2 ? {} : { display: "none" }}>
                                                ...
                                                <Card id="CardTiket" body>
                                                  ...
                                                  <Row style={{ marginRight: 0 + "px" }}>
                                                    ...
                                                    <Col>
                                                      <img id="AirilineLogo" src={item.Data[0].ReturnairlineLogo[1]} alt='img' />
                                                      <p id="AirilineName">
                                              ...
                                              <div style={item.Data[0].ReturnStops === 2 ? {} : { display: "none" }}>
                                                ...
                                                <Card id="CardTiket" body>
                                                  ...
                                                  <Row style={{ marginRight: 0 + "px" }}>
                                                    ...
                                                    <Col>
                                                      <img id="AirilineLogo" src={item.Data[0].ReturnairlineLogo[2]} alt='img'/>
                                                      <p id="AirilineName">
