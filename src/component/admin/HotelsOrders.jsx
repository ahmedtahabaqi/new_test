...
class GuestsOrders extends React.Component {
  constructor() {
    super();
    this.state = {
      Email: '',
                      ...
                      <div className="container-fluid">
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Hotels Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                {ctx.value.HotelsOrders.map((item, i) => (
                                  <tr key={i}>
                                    <td>{i + 1}</td>
                                    <td >{item.uptime}</td>
                                    <td>{item.user}</td>
                                      ...
                                      <Component initialState={{ isShown: false }}>
                                        {({ state, setState }) => (
                                          <Pane>
                                            ...
                                            >
                                              {item.Data[0].Data.Rooms.map((room, r) => (
                                                <Card key={r} id="CardTiket" body>
                                                  <Alert id="infoRoomStars" variant="primary">

                                                    <img alt='img' id="HotelNameIcon" src={host + item.Data[0].Data.img} />
                                                    {room.name}
                                                    <StarRatings

                                                      starDimension="25px"
                                                      starSpacing="1px"
                                                      rating={item.Data[0].Data.stars}
                                                  ...
                                                  <Row>
                                                    <Col>
                                                      <div >
                                                        ...
                                                        <center><h4>Room information</h4></center>
                                                        <ListGroup>

                                                          <ListGroup.Item ><b>CheckIn</b>: {item.Data[0].info.CheckIn}</ListGroup.Item>
                                                          <ListGroup.Item><b>CheckOut</b>: {item.Data[0].info.CheckOut}</ListGroup.Item>

                                                          {item.Data[0].op.map((option, r) => (
                                                            <ListGroup.Item key={r}><b>{option.name}</b>: {option.Cost}$</ListGroup.Item>
                                                          ))}
                                                        </ListGroup>
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Guests Hotels Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              <thead className="thead-dark">
