                  ...
                  <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <li className="nav-item active">
                      <span id="AdminSideBarLinkA" className="nav-link" >
                        ...
                        <span>Tours Completed Orders</span></span>
                    </li>
                      ...
                      <div className="container-fluid">
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Tours Completed Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                {ctx.value.ToursOrdersCompleted.map((item, i) => (
                                  <tr key={i}>
                                    <td>{i + 1}</td>
                                    <td >{item.uptime}</td>
                                    <td>{item.user}</td>
                        ...
                        <div className="card shadow mb-4">
                          <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Guests Tours Completed Orders</h6>
                          </div>
                          <div className="card-body">
                            <table className="table">
                              <thead className="thead-dark">
